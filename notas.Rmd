...
# Junta para formar o nome completo.
nt <- nt %>%
...
# Calcula as nota média por sabatina.
ntg <- ntg %>%
...
```{r, eval = !is.null(nts$Faltas), echo = FALSE, fig.cap = cap, message = FALSE, warning = FALSE, results = "hide"}
ggplot(data = nts,
